    ...
    <div className="relative w-full h-full flex justify-center">
      <div className="relative w-full max-w-md md:max-w-lg lg:max-w-xl aspect-[3/4] bg-background">
        <svg
          ...
          aria-label="Map of Sweden with interactive regions"
        >
          {Object.entries(simplemaps_countrymap_mapinfo.paths).map(
            ([code, d]) => {
              const regionInfo = regions.find((r) => r.code === code);
              const fillColor = regionInfo
                ? "rgba(0, 82, 147, 0.7)"
                : "lightgray";
              return (
                <path
                  ...
                  className={
                    regionInfo
                      ? "cursor-pointer transition-all hover:fill-swedish-blue"
                      : ""
                  }
                  onClick={
                    regionInfo
                      ? () => handleRegionClick(regionInfo)
                      : undefined
                  }
                />
              );
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-md max-h-[80vh] overflow-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedRegion?.groups} active groups in this area
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 mt-4">
            ...
            <Button asChild className="w-full">
              <Link href="/app/discover">
                View All Groups in {selectedRegion?.name}
              </Link>
            </Button>
          </div>
        </DialogContent>
